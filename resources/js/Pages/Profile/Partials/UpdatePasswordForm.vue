    ...
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Используйте длинный и случайный пароль для повышения безопасности вашего аккаунта.
            </p>
        </header>

        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            <div>
                <InputLabel for="current_password" value="Текущий пароль" class="text-gray-700 dark:text-gray-300" />
            ...
            <div>
                <InputLabel for="password" value="Новый пароль" class="text-gray-700 dark:text-gray-300" />
